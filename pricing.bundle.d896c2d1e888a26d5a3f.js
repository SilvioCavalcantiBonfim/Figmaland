...
;// CONCATENATED MODULE: ./src/component/pricing.component.ts
    ...
    render(args) {
        ...
        const _heading = BuilderElement("div", {
            ...
            appendChild: [
                ...
                BuilderElement("h3", {
                    className: ["d-flex", "flex-column", "align-items-center"],
                    innerText: (_b = args.title) !== null && _b !== void 0 ? _b : "title",
                }),
                // subtitulo
                BuilderElement("h6", {
                    className: ["m-0", "text-center"],
                    innerText: (_c = args.subtitle) !== null && _c !== void 0 ? _c : "subtitle",
                }),
            ],
        });
        ...
        const _container = BuilderElement("article", {
            ...
            style: {
                color: (_d = args.color) !== null && _d !== void 0 ? _d : "#000000",
                backgroundColor: (_e = args.bg) !== null && _e !== void 0 ? _e : "#FFFFFF",
            },
